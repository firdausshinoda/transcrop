                    ...
                    <div class="card-body row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="text-center">
                                <img src="{{asset('upload/bank/'.$data->foto_bank)}}" class="w-50" id="PreviewImg">
                            </div>
                            <div class="custom-file mt-3" id="view_upload_paper">
                                ...
                                <input type="hidden" name="id" id="id" value="{{$data->id_bank}}">
                                <input type="hidden" name="foto_bank_lama" id="foto_bank_lama" value="{{$data->foto_bank}}">
                                <label class="custom-file-label text-default" for="ful_paper">CARI FOTO</label>
                            </div>
                        </div>
                        <div class="form-group col-sm-12 col-md-4">
                            <label><b>Nama Bank</b></label>
                            <input type="text" class="form-control" id="nama_bank" name="nama_bank" value="{{$data->nama_bank}}" placeholder="Masukkan nama bank..."/>
                        </div>
                        <div class="form-group col-sm-12 col-md-4">
                            <label><b>Atas Nama Bank</b></label>
                            <input type="text" class="form-control" id="an_bank" name="an_bank" value="{{$data->an_bank}}" placeholder="Masukkan atas nama bank..."/>
                        </div>
                        <div class="form-group col-sm-12 col-md-4">
                            <label><b>No Rekening</b></label>
                            <input type="text" class="form-control" id="norek_bank" name="norek_bank" value="{{$data->norek_bank}}" placeholder="Masukkan no rekening..."/>
                        </div>
                    </div>
       ...
       $(function() {
           $('#formExecute').validate({
               rules: {
                   ...
                   foto_bank: { extension: "png|jpeg|jpg|PNG|JPEG|JPG", filesize: 1000000, },
               },
               messages: {
                   nama_bank: { required: "Silahkan diisi...", }, an_bank: { required: "Silahkan diisi..." }, norek_bank: { required: "Silahkan diisi..." },
                   foto_bank: { extension: "Hanya PNG , JPEG , JPG...", },
               },
                   ...
                   swalWithBootstrapButtons.fire({
                       ...
                       preConfirm: function () {
                           return new Promise(function (resolve) {
                               ...
                               values.append("foto_bank_lama",$('#foto_bank_lama').val());
                               $.ajax({
                                   type: "POST",data:values, url: "{{ url('/api_bank_update') }}",
