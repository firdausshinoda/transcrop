                ...
                <form id="formExecute">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" name="id" id="id" value="{{$data->id_jenis_kendaraan}}">
                            <input type="text" class="form-control" name="jenis_kendaraan" id="jenis_kendaraan" placeholder="Silahkan diisi..." value="{{$data->jenis_kendaraan}}">
                        </div>
                    </div>
                    ...
                    swalWithBootstrapButtons.fire({
                        ...
                        preConfirm: function () {
                            return new Promise(function (resolve) {
                                ...
                                $.ajax({
                                    type: "POST",data:values, url: "{{ url('/api_jenis_kendaraan_update') }}",
